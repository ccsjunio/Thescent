...
GLRenderStateHelper::GLRenderStateHelper()
{
	return;
}


void GLRenderStateHelper::SaveCurrentGLState(void)
{
...
bool GLRenderStateHelper::RestoreCurrentGLState(std::string &error)
{
