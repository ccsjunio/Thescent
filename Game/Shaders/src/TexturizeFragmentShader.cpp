#include "..\include\TexturizeFragmentShader.h"
#include <BellEngineID.h>
#include <LightPoint.h>
#include <LightDirectional.h>
#include <LightSpot.h>

const bool TexturizeFragmentShader::GetUniformLocations()
{
...
TexturizeFragmentShader::TexturizeFragmentShader()
{
	this->tiling_ul =
...
const unsigned long long TexturizeFragmentShader::GetTypeID()
{
	return ENGINE_OBJ_ID_GPH_GLSHADER_FRAGMENT_TEXTURIZE;
}

const std::string TexturizeFragmentShader::GetType()
{
	return "TexturizeFragmentShader";
}

const std::string TexturizeFragmentShader::GetName()
{
	return this->name;
}

void TexturizeFragmentShader::SetName(const std::string& name)
{
	this->name = name;
}

const bool TexturizeFragmentShader::Initialize()
{
	bool rc = true;
...
void TexturizeFragmentShader::SetProgramID(const unsigned int& programID)
{
...
const bool TexturizeFragmentShader::SetLights(const std::vector<ILight*>& lights)
{
...
const bool TexturizeFragmentShader::SetDiffuse(const Vector4D& value)
{
	glUniform4f(this->diffuseColour_UL, value.r, value.g, value.b, value.a);
	return true;
}

const bool TexturizeFragmentShader::SetSpecular(const Vector4D& value)
{
	glUniform4f(this->specularColour_UL, value.r, value.g, value.b, value.a);
	return true;
}

const bool TexturizeFragmentShader::SetTextures(const std::vector<ITexture*>& textures)
{
...
const bool TexturizeFragmentShader::SetUVOffset(const Vector2D& value)
{
	glUniform2f(this->uvoffset_ul, value.x, value.y);
	return true;
}

const bool TexturizeFragmentShader::SetTiling(const Vector2D& value)
{
	glUniform2f(this->tiling_ul, value.x, value.y);
	return true;
}

const bool TexturizeFragmentShader::SetTransparency(const int& value)
{
